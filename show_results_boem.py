...
regions = ['ak.' + reg for reg in ['GOA', 'KOD', 'SHU', 'ALA',
...
if __name__ == '__main__':
    ...
    row_order = ['ak.{}'.format(r) for r in ['ALA', 'ALB', 'BOW', 'GOA', 'GEO', 'KOD', 
                                              'MAT', 'NAL', 'NAV', 'NOR', 'SHU', ]]
    ...
    df0.to_csv(
        #'results/{}_AK-BOEM_Baseline_Results.csv'.format(range_tag),
        'results/AK-BOEM_Baseline_Results.csv'.format(range_tag),
        columns=col_order)
