...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.6 \linewidth]{./fig/Dot-Product_Schematic}
...
\begin{figure}[ht]
    \centering
    \fbox{\includegraphics[width=0.3\linewidth]{./fig/omni-dir01}}
    \fbox{\includegraphics[width=0.3\linewidth]{./fig/omni-dir02}}
    \fbox{\includegraphics[width=0.3\linewidth]{./fig/omni-dir03}}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{./fig/Schematic03.pdf}
