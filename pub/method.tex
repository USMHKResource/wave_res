...
\note{What we need to cover in this section:}
%Further details on $R_l$ and each of these cases be found in section \ref{sec:method:calc:local}; a discussion of the pros/cons of the two approaches can be found in section \note{???}.
