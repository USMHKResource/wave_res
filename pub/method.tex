...
\item It should utilize well-defined boundaries to define resource areas \note{Levi: this will also make the method is transferable and scalable. Should we say that?}
\end{itemize}
...
% ... in order to get consistent/comparable results. The borders must ... But don't count fluxes across {\it borders}
...
% Include `local' winds within a nation's EEZ (this is new!)
\end{itemize}
...
\end{enumerate}
\note{Do we also need to mention minor differences in method: different model/physics packages? Other?}
